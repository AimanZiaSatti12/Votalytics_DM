...
if uploaded_trump_file is not None:
    Trump_reviews = pd.read_csv(uploaded_trump_file, index_col=0)
if uploaded_biden_file is not None:
    Biden_reviews = pd.read_csv(uploaded_biden_file, index_col=0)
