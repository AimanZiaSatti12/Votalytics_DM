...
if senate_df is not None and presidential_df is not None:
...
uploaded_trump_file = st.file_uploader("Upload Trump CSV file", type="csv")
uploaded_biden_file = st.file_uploader("Upload Biden CSV file", type="csv")
